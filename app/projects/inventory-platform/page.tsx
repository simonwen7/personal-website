        ...
        <article className="mx-auto max-w-6xl">
          ...
          <section className="mt-8 rounded-[2rem] border border-white/70 bg-white/80 p-8 shadow-2xl shadow-gray-200/70 backdrop-blur-xl md:p-12">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-gray-600">
              A backend-focused inventory platform designed around API structure,
              database workflows, inventory updates, and scalable service
              organization.
            </p>
  
            <div className="mt-8 flex flex-wrap gap-2">
              {["Backend", "SQL", "API", "Caching", "Distributed Systems"].map(
                (item) => (
                  <span
                    key={item}
          ...
          <section className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              {
                title: "Problem",
                text: "Inventory systems need to keep product quantities consistent while handling updates, reads, and operational workflows across different parts of an application.",
              },
              {
                title: "Solution",
                text: "The platform is structured around backend APIs, database operations, and service-level logic that can support inventory lookup, stock updates, and future scaling.",
              },
              {
                title: "My Role",
                text: "I focused on backend architecture, API design, SQL-centered data workflows, and creating a structure that could be extended with caching and distributed service patterns.",
              },
            ].map((section) => (
              <div
                key={section.title}
            ...
            <div className="grid gap-8 md:grid-cols-[0.8fr_1.2fr]">
              <div>
                ...
                <h2 className="mt-4 text-3xl font-black">
                  API layer → service logic → database workflow → scalable backend.
                </h2>
  
                <p className="mt-5 leading-8 text-gray-300">
                  This project is positioned as a backend engineering project,
                  emphasizing clean API boundaries, database-centered logic,
                  maintainable service structure, and future support for
